...
edge_driver_path = "YOUR CHROME DRIVER PATH"

# Optional - Automatically keep your edgedriver up to date.
# from webdriver_manager.edge import EdgeDriverManager  # pip install webdriver-manager
# edge_driver_path = EdgeDriverManager(path=YOUR CHROME DRIVER FOLDER).install()
